...
const MyHeader = () => {
  ...
  return (
    <div className='w-full h-[45px]  md:h-[60px] border-1px flex place-content-evenly place-items-center  top-0 backdrop-filter backdrop-blur-xl'>
        <div className="md:w-[20%] w-[30%]  h-full lg:tracking-wider lg:text-4xl capitalize flex justify-start text-xl  items-center font-semibold tracking-wide md:ml-[35px] md:text-2xl">
            justBuy
        </div>
        <div className="md:flex lg:w-[40%] md:w-[50%] h-full  hidden place-content-evenly place-items-center ">
            <NavLink to={"/"} style={setActiveLink} className={' md:w-[11%] lg:w-[8%] h-[50%]  flex justify-center items-center  tracking-wide '}>
                Home
            </NavLink>
            <NavLink style={setActiveLink} to={"contact"} className={' md:w-[11%] lg:w-[10%] h-[50%]  flex justify-center items-center  tracking-wide '}>
                Contact
            </NavLink>
            <NavLink style={setActiveLink} to={"about"} className={' md:w-[11%] lg:w-[9%] h-[50%]  flex justify-center items-center  tracking-wide'}>
                About
            </NavLink>
            <NavLink style={setActiveLink} to={"sign-up"} className={' lg:w-[12%] md:w-[17%]  h-[50%]  flex justify-center items-center tracking-wide'}>
                Sign up
            </NavLink>
        </div>
        ...
        <svg onClick={() =>{
            ...
            setShowSearchInput(!showSearchInput)}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className='w-[25px] lg:hidden fill-stroke text-gray-700'>
         <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
           </svg>
            <div className='w-[65%] h-[60%] hidden  relative lg:block '>
                <input className='w-[100%] text-md h-[100%] focus:outline-none focus:shadow-md placeholder:text-md pl-2 text-gray-400 bg-gray-100 rounded-sm' type="text" placeholder='What are you looking for?' />
