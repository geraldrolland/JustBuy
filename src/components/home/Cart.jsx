...
export const Cart = () => {
  ...
  return (
    <>
    <div className='w-[100px] ml-[5%] mt-[60px] h-[30px] inline-flex text-gray-400 justify-between items-center'><span>Home</span><span>/</span><span className='text-gray-900'>Cart</span></div>
    ...
    { data.length ?  data.map(product =>
          ...
          <div className='w-[95%]  h-[100%] flex justify-between items-center'>
              ...
              <div className='w-[60px] border-gray-900 rounded-[4px] flex justify-evenly items-center h-[80%] border-1px'>
                ...
                <div className='h-[100%] w-[40%]  flex justify-between flex-col items-center'>
                    <SlArrowUp onClick={() => {increaseQuantity(product.id)}} className='w-[10px]' /> 
                    <SlArrowDown onClick={() => {decreaseQuantity(product.id)}} className='w-[10px]' />                               
                </div>
              </div>
                    ...
                    <div className='w-[44%] rounded-[4px] border-gray-400 h-[100%] border-2px flex justify-center items-center'>
                        <div className='w-[90%] h-[85%]'>
                            ...
                            <div className='w-[100%] h-[50px] border-b-2px border-gray-300 flex justify-between items-center'>
                                ...
                                <h1 className='text-gray-600 capitalize text-[18px]'>$1750</h1>
                            </div>
                            <div className='w-[100%] h-[50px] border-b-2px border-gray-300 flex justify-between items-center'>
