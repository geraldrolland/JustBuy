...
const Product = ({prod, scroll, showView, buttonLeft, buttonRight}) => {
  ...
  return (
    <div className='md:w-[230px] lg:last:self-start shadow-md rounded-md product md:shadow-sm product  md:mr-[20px] mb-14  mr-2  lg:first:mt-10 md:first:mt-14  md:h-[350px] w-[170px] h-[300px]  md:mb-0  md:mt-[25px]'>
